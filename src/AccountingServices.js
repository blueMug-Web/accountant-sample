...
const AccountingServices = () => {
	return (
					...
					<div className="flex flex-col lg:flex-row">
						...
						<div className="w-full mt-8 lg:mt-0">
							<p className="text-lg lg:text-2xl font-medium mb-8 text-gray-600">
								Lorem ipsum dolor sit amet. Consectetur adipiscing elit maecenas
								sed pharetra magna tortor.
							</p>
							<p className="text-gray-500 leading-loose">
								Lorem ipsum dolor sit amet, consectetur adipiscing elit.
								Facilisis gravida sagittis purus eget vitae faucibus sed tortor
								blandit. Tristique sit viverra posuere vestibulum bibendum
								donec. Placerat amet tellus mauris quis aliquet fames aliquam.
								Sagittis, morbi suspendisse vitae mollis bibendum. Dolor, vitae,
								amet purus feugiat malesuada molestie. Nibh malesuada viverra
								turpis id. Euismod molestie fermentum volutpat bibendum arcu
								cursus non. Augue leo sollicitudin ut pretium quis et cursus
								nunc. Tristique sit viverra posuere vestibulum bibendum donec.
								Placerat amet tellus mauris quis aliquet fames aliquam.
							</p>
				...
				<div id="service2" className="mt-16 md:mt-20 lg:mb-72">
					<div className="font-plexSerif font-bold flex flex-col lg:flex-row-reverse lg:mb-36">
						...
						<span className="text-2xl  lg:text-5xl lg:mr-22 text-gray-700">
							Another brilliant service that you will benefit a great deal from.
						</span>
					</div>
      ...
      <h2 className="thick_underline uppercase tracking-wider text-4xl lg:text-5xl text-gray-700">Testimonials</h2>
      <div className="flex flex-row flex-wrap justify-center pt-40 pb-18 max-w-screen-2xl">
        ...
        <div className="w-72 lg:w-72 mx-10 shadow-md bg-white mb-16 lg:mb-0">
          <p className="px-6 pt-8 pb-20 text-center text-gray-500">“Nec gravida tempus, lobortis elit augue tellus. Dolor,
            et ipsum porta pharetra. Risus nunc turpis vehicula sed. Volutpat mollis quam volutpat nulla pellentesque.”
          </p>
          <div className="flex flex-col items-center pb-6 bg-gray-100">
            <img className="rounded-full w-24 border-4 -mt-12 border-white shadow-inner"
              src={smiling_man} alt="" />
      ...
      <a className="inline-block py-2 my-5 px-3 uppercase border  border-green-600 text-green-600 hover:bg-green-500 hover:border-green-500 hover:text-blue-50 focus:ring-2 focus:ring-green-300"
        href="/testimonials">Read More</a>
			...
			<section className="get_started__header flex flex-col items-center pt-14 pb-16 lg:pt-18 lg:pb-20 bg-white">
				...
				<a
					className="link_underline inline-block text-2xl mt-16 text-gray-600"
					href="/"
				>
